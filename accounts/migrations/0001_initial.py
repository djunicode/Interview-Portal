# Generated by Django 4.0.3 on 2022-05-18 15:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(blank=True, choices=[('Frontend', 'Frontend'), ('Django', 'Django'), ('Node', 'Node'), ('React Native', 'React Native'), ('Fullstack Node', 'Fullstack Node'), ('Flutter', 'Flutter'), ('Fullstack Django', 'Fullstack Django')], max_length=20)),
                ('resources', models.FileField(blank=True, max_length=200, upload_to='')),
            ],
        ),
        migrations.CreateModel(
            name='Task',
            fields=[
                ...
                ('task_resources', models.FileField(blank=True, upload_to='')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stack', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='accounts.applicationstack')),
            ],
        ),
        migrations.CreateModel(
            name='Interviewer',
            fields=[
                ...
                ('panel', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='accounts.panel')),
