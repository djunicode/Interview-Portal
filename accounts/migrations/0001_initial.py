# Generated by Django 4.0.3 on 2022-06-13 12:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rating', models.IntegerField(blank=True)),
                ('scorecard', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='accounts.scorecard')),
            ],
        ),
        migrations.CreateModel(
            name='Panel',
            fields=[
                ...
                ('interviewees', models.ManyToManyField(to='accounts.interviewee')),
                ('interviewers', models.ManyToManyField(to='accounts.interviewer')),
            ],
        ),
        migrations.AddField(
